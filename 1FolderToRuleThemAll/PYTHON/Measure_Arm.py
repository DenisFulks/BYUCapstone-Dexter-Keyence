...
def main(filename=None, auto_flag=False, scan_type='live', ui=None, debug_flag=False):
    ...
    # Find bar faces
    scan1.fit_bar_faces(plotNum=0, cutOff=[5, 200], show=debug_flag)    #-25, 300
    ...
    scan1.fit_spindle_3D3(axial_cutoff=-145, side='left', show_flag=debug_flag, plot_flag=False, box_size=8.0)     #-70
